<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dizigerilim.aspx.cs" Inherits="WebApplication4.dizigerilim" %>
...
<title>IMDC | Gerilim Dizileri</title>
...
<body background="arkaplan.jpg">
  ...
  <tr>
    <th><center><h1>Gerilim Dizileri</h1></th>
  </tr>
</table>
<br><br>
   ...
   <center><table style="width:460px">
       ...
       <tr>
        ...
        <td><a href="sherlock.aspx" class="text-secondary"><center><h1>Sherlock</h1></center></a></td></td>
      </tr>
       ...
       <tr>
        ...
        <td><a href="stranger_things.aspx" class="text-secondary"><center><h1>Stranger Things</h1></center></a></td>
      </tr>
